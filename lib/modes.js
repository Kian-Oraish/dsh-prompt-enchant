...
const DESIGN_LAYER = [
  ...
  '',
  '【输出格式】沿用硬性规则 5(纯文本、中文方括号标题):图像场景可用【画面】【风格】【构图】【光照】等小节;视频场景可用【场景】【运镜】【节奏】【首帧】【尾帧】等小节;按需选用,不要硬凑。缺失且无法可靠推断的要素统一严格使用完整格式【待确认:要素名(候选A/候选B)】标注(含方括号),并附 2-3 个最可能候选;给不出候选时写作【待确认:要素名】。',
].join('\n')
